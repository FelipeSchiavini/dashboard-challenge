...
import {
  LargeSeparator,
  Separator,
} from "@/components/separator/separator.component";
...
export const Home: React.FC = () => {
  ...
  return (
    <Background>
      ...
      <LargeSeparator borderBottom />
      {transactions.length ? (
        <DataVisualization transactions={transactions} />
      ) : (
        <Placeholder
          title="No data found"
          description="Can't find what you're looking for? Start a new search."
        />
      )}
    </Background>
  );

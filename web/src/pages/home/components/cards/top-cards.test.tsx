...
describe('TopCards Component', () => {
    ...
    it('renders the correct number of Card components', () => {
        const { getByText } = render(<TopCards totals={mockTotals} averageTicket={mockAverageTicket} />);
        expect(getByText(formattedNumber(mockTotals.administrationFee))).toBeTruthy();
